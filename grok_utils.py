...
MODEL_NAME = "grok-2-1212"  # Grok的模型名称
...
def chat_with_function(memory: ChatMemory, function_call=None, tool_choice="auto"):
    """
    调用 Grok 进行对话
    ...
    if response.choices[0].finish_reason == 'tool_calls':
        ...
        for tool_call in tool_calls:
            ...
            if respone_message.content == '':
                respone_message.content = "执行!"

            new_messages = messages + \
                [respone_message.to_dict(), function_call_result_message]
